  ...
  <div class="l-auth-container">
    <div class="l-auth">
      <v-form v-model="validLogin">
        ...
        <!-- <v-btn flat :color="maincolor" @click.native="signUpVisible = true">Create account</v-btn> -->
        <v-btn :color="maincolor" @click.native="submitAuthentication()">Login</v-btn>
      </v-form>
    </div>
    ...
    <div class="l-signup" v-if="signUpVisible">
      <v-form v-model="validSignUp">
        ...
        <v-btn block :color="maincolor" @click.native="submitSignUp()">Sign Up</v-btn>
      </v-form>
    </div>
